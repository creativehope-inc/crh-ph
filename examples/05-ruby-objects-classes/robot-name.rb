...
# Robot Name
#
# Create a Robot class that instantiates a robot with a unique name
# in the format of two uppercase letters followed by three digits, such as RX837 or BC811
#
# It also has a reset method that resets the name of the Robot.
#
# The class method .forget is to clear the shared state across all robots
